...
var client_references_default = {
	...
	"5b777958e3fd": async () => {
		const m = await import("./assets/error-boundary-Bkbqw1Qo.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-D7-_JNMz.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"cfee43ca1bc7": async () => {
		const m = await import("./assets/layout-segment-context-BG1522ZS.js");
