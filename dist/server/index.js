...
function getDraftSecret() {
	return "8753c9e6-e497-4d6f-b9de-bdf006bc326f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "761e0921-d717-4b4a-bdb6-42b1ebf89a4f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "761e0921-d717-4b4a-bdb6-42b1ebf89a4f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "761e0921-d717-4b4a-bdb6-42b1ebf89a4f",
		rootBoundaryId
	});
}
/**
