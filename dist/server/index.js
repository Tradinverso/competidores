globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-iWXsmODD.js","assets/layout-segment-context-CJ0vonnb.js"];
...
function getDraftSecret() {
	return "d230affb-ce1d-48df-9934-b8df1de8d20a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "61f2a705-1ee6-4b16-b18a-6fa2e1bec3bc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "61f2a705-1ee6-4b16-b18a-6fa2e1bec3bc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "61f2a705-1ee6-4b16-b18a-6fa2e1bec3bc",
		rootBoundaryId
	});
}
/**
