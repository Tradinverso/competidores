...
function getDraftSecret() {
	return "7615ab17-979d-43af-8f97-d43ddc58a18f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2b6820fe-28ee-4e5e-b6de-9668e59f9b54";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2b6820fe-28ee-4e5e-b6de-9668e59f9b54") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2b6820fe-28ee-4e5e-b6de-9668e59f9b54",
		rootBoundaryId
	});
}
/**
