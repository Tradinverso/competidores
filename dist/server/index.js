...
function getDraftSecret() {
	return "34f1c597-2a92-4530-94f1-fedb5b5fba96";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2b868493-daf3-46ab-b391-3204a60cfb88";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2b868493-daf3-46ab-b391-3204a60cfb88") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2b868493-daf3-46ab-b391-3204a60cfb88",
		rootBoundaryId
	});
}
/**
