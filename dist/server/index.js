...
function getDraftSecret() {
	return "02b7cc48-85bd-4f66-a93d-be2d49dd9844";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "99fa0e30-d35a-4d01-a74b-3167787662ca";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "99fa0e30-d35a-4d01-a74b-3167787662ca") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "99fa0e30-d35a-4d01-a74b-3167787662ca",
		rootBoundaryId
	});
}
/**
