...
function getDraftSecret() {
	return "91429d05-f664-44ad-9cb0-70ee389419ce";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3afaf0a8-d157-4064-9751-650738427fab";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3afaf0a8-d157-4064-9751-650738427fab") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3afaf0a8-d157-4064-9751-650738427fab",
		rootBoundaryId
	});
}
/**
